...
/*
 * Extending the functionalities through inserting property names and functionalities to get the session key 
 */
...
class RedisSession {
  ...
  middleware (sessionProperty, getSessionKey) {
    return (ctx, next) => {
      ...
      return this.getSession(key).then((session) => {
        ...
        Object.defineProperty(ctx, /*this.options.*/sessionProperty, {
